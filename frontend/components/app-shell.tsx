...
export function AppShell({ children, onNavigate, userName }: Readonly<{ children: React.ReactNode; onNavigate?: (label: string) => void; userName: string }>) {
  ...
  return (
    <div className="min-h-screen bg-[#141414] text-[#f4f3ee]">
      <aside className={`fixed inset-y-0 left-0 z-20 hidden border-r border-[#ffffff12] bg-[#080808] transition-[width] duration-200 lg:flex lg:flex-col ${collapsed ? "w-[112px]" : "w-[232px]"}`}>
